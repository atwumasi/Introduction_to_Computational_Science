...
class MAT3 {
  ...
  public:
    ...
    void operator+= (const MAT3& mat); // To implement
    void operator-= (const MAT3& mat);
...
MAT3 operator+ (const MAT3& input_1, const MAT3& input_2); // To implement
MAT3 operator+ (const MAT3& input_1);
MAT3 operator- (const MAT3& input_1, const MAT3& input_2);
MAT3 operator- (const MAT3& input_1);
MAT3 operator* (const double& input_s, const MAT3& input_m); // To implement
MAT3 operator* (const MAT3& input_m, const double& input_s);
MAT3 operator* (const MAT3& input_1, const MAT3& input_2);
MAT3 operator/ (const MAT3& input_m, const double& input_s);

VEC3 operator* (const MAT3& input_m, const VEC3& input_v); // To implement
